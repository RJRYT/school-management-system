...
const LibraryHistory = ({ role = "user" }) => {
    ...
    >
      ...
      <div className="px-4 py-6 mx-auto max-w-7xl">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-2xl font-semibold text-white">Library history list</h2>
          {role !== "staff" && <Link
            to="new"
          ...
          <table className="min-w-full rounded-lg">
            <thead className="bg-blue-600/30 backdrop-blur-sm text-white">
              <tr>
                ...
                <th className="text-left py-3 px-4">Borrow Student</th>
                <th className="text-left py-3 px-4">Issue Date</th>
                <th className="text-left py-3 px-4">Return Date</th>
                <th className="text-left py-3 px-4">Status</th>
                {role !== "staff" && <th className="text-left py-3 px-4">Actions</th>}
              </tr>
            </thead>
